...
// symbol: verifyClaudeCodeRuntimeAvailable  (minified: ele, daemon.pretty.js:57135)
// NOTE: readable extract from daemon.recon.js; references other top-level
// symbols. The runnable artifact is recon/daemon.recon.js (provably equivalent).

function verifyClaudeCodeRuntimeAvailable() {
 if (h_(process.env.CLAUDE_CODE_EXECUTABLE)) return;
 let {
  platform: t,
  arch: n
 ...
 try {
  if (!z9e(c)
   .isFile()) throw new Error(`[agent-sdk] platform binary at ${c} exists but is not a regular file`)
 } catch (u) {
