...
// symbol: verifyClaudeCodeRuntimeAvailable  (minified: $he, daemon.pretty.js:55039)
...
function verifyClaudeCodeRuntimeAvailable() {
    ...
    try {
        if (!mrt(u).isFile()) throw new Error(`[agent-sdk] platform binary at ${u} exists but is not a regular file`)
    } catch (l) {
