...
// symbol: AgentSdkPromptNotAcceptedAbortError  (minified: oo, daemon.pretty.js:49739)
// NOTE: readable extract from daemon.recon.js; references other top-level
// symbols. The runnable artifact is recon/daemon.recon.js (provably equivalent).

var CLAUDE_CORE_TOOLS, PARTITION_CORE_TOOLS, kue, S9e, k9e, AgentSdkTurnInterruptedError, AgentSdkPromptNotAcceptedAbortError, wu, kd, Pue, wU, Eue, O9e, ba = $(() => {
    "use strict";
    Zt();
    tu();
    Sd();
    ...
    Pue = () => verifyClaudeCodeRuntimeAvailable(), wU = Pue, Eue = 5e3;
    O9e = 2147483647
});
