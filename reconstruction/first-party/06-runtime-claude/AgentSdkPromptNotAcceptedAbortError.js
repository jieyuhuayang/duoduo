...
// symbol: AgentSdkPromptNotAcceptedAbortError  (minified: Ir, daemon.pretty.js:55516)
// name: authoritative — upstream's own name, from an esbuild __export block or the bundle's export statement
// NOTE: readable extract from daemon.recon.js; references other top-level
// symbols. The runnable artifact is recon/daemon.recon.js (provably equivalent).

var CLAUDE_CORE_TOOLS, PARTITION_CORE_TOOLS, khe, hrt, grt, AgentSdkTurnInterruptedError, AgentSdkPromptNotAcceptedAbortError, dc, xf, Phe, mB, Ehe, xrt, vo = O(() => {
    "use strict";
    mt();
    Au();
    Bu();
    ...
    Phe = () => verifyClaudeCodeRuntimeAvailable(), mB = Phe, Ehe = 5e3;
    xrt = 2147483647
});
