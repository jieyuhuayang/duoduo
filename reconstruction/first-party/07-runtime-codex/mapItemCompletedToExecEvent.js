...
// symbol: mapItemCompletedToExecEvent  (minified: Kye, daemon.pretty.js:62646)
...
function mapItemCompletedToExecEvent(e) {
    ...
    switch (t) {
        ...
        case "webSearch":
            return {
                type: "tool_result", toolUseId: n, toolName: "WebSearch", isError: !1, summary: Dst(e.action, e.query ?? "")
            };
        case "plan":
            return {
